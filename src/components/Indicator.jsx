    ...
    return (
        <>
            ...
            <table className={`table-auto w-full border-2 ${backgroundColor}`}>
                <thead>
                    <tr>
                        <th className="px-4 py-2 text-left border-b">Index</th>
                        <th className="px-4 py-2 text-left border-b">Ticker</th>
                        <th className="px-4 py-2 text-left border-b">Price</th>
                        <th className="px-4 py-2 text-left border-b">Change Amount</th>
                        <th className="px-4 py-2 text-left border-b">Change Percentage</th>
                ...
                <tbody>
                    {data.map((stock, index) => (
                        <tr key={index} className="hover:bg-gray-100">
                            ...
                            <td className="px-4 py-2 border-b">{stock.change_amount}</td>
                            <td className="px-4 py-2 border-b">{stock.change_percentage}</td>
